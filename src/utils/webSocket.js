...
async function openModuleInfo(modelNum, modelType, newModelName, commonName, parametersStr) {
  ...
  var ret
  SendMessage('{"ApiName":"ApiOpenModel","Arguments":{"ModelPath":"' + filePath + '","NewModelName":"' + newModelName + '","PtcCommonName":"' + commonName + '","Parameters":[' + parametersStr + ']}}');
...
async function assembleModuleInfo(modelNum, modelType, parentAsmName, newModelName, commonName, parametersStr) {
  ...
  var sendStr = '{"ApiName":"ApiAssembleModelWithProeInterface","Arguments":{"ModelPath":"'
    + filePath + '","ParentAsmName":"' + parentAsmName + '","NewModelName":"' + newModelName
    + '","PtcCommonName":"' + commonName + '","Parameters":[' + parametersStr + ']}}'
  console.log('sendStr=')
  console.log(sendStr)
  SendMessage(sendStr)
  ret = await ReceiveMessage()
...
async function assembleModuleInfoByCsys(modelNum, modelType, parentAsmName, newModelName, commonName, parametersStr, childZbx, ParentZbx) {
  ...
  var sendStr = '{"ApiName":"ApiAssembleModelRenamedByParameter","Arguments":{"ModelPath":"'
    + filePath + '","ParentAssemblyName":"' + parentAsmName + '","NewModelName":"' + newModelName
    + '","ParentCsysName":"' + ParentZbx + '","ComponentCsysName":"' + childZbx
    + '","AllowAssembleManually":"true","Parameters":[' + parametersStr + ']}}'
  console.log('sendStr=')
  console.log(sendStr)
  SendMessage(sendStr)
  ret = await ReceiveMessage()
...
async function SetModelParameterInFirstCsys(moduleNum, moduleType, parametersStr) {
  ...
  var ret;
  var jsonNum = '{"ApiName": "ApiSetModelParameterInFirstCsys","Arguments":{ "ModelName": "' + moduleNum + '","ModelType": "' + moduleType + '", "Parameters": [' + parametersStr + ']}}';
...
async function ApiExtSyncFilterModels(filename, templateName, filterKey, filterValuePropStr, returnValuePropStr) {
  ...
  var ret;
  var jsonNum = '{"ApiName": "ApiExtSyncFilterModels","Arguments":{ "filename": "' + filename + '","template": "' + templateName + '","filterKey": "' + filterKey + '", "filterValue": [' + filterValuePropStr + '], "parameters": [' + returnValuePropStr + ']}}';
  console.log("jsonNum-------" + jsonNum);
  SendMessage(jsonNum);
...
async function ApiExtSyncFilterUDFs(filename, templateName, filterKey, prefix, filterValuePropStr, returnValuePropStr) {
  ...
  var ret;
  var jsonNum = '{"ApiName": "ApiExtSyncFilterUDFs","Arguments":{ "filename": "' + filename + '","template": "' + templateName + '","filterKey": "' + filterKey + '","prefix": "' + prefix + '", "filterValue": [' + filterValuePropStr + '], "parameters": [' + returnValuePropStr + ']}}';
  console.log("jsonNum-------" + jsonNum);
  SendMessage(jsonNum);
...
async function ApiExtSyncFilterUDFs2(filename, templateName, filterKey, prefix) {
  ...
  var ret;
  var jsonNum = '{"ApiName": "ApiExtSyncFilterUDFs2","Arguments":{ "filename": "' + filename + '","template": "' + templateName + '","filterKey": "' + filterKey + '","prefix": "' + prefix + '" }}';
  console.log("jsonNum-------" + jsonNum);
  SendMessage(jsonNum);
...
async function ApiExtAssembleUDF(udfRefCsysName, udfTemplate, udfX, udfY, udfZ, udfSide) {
  ...
  var ret;
  var jsonNum = '{"ApiName": "ApiExtAssembleUDF","Arguments":{ "filename": "","udfRefCsysPath":"","udfRefCsysIds":"","udfRefCsysName":"' + udfRefCsysName + '","udfTemplate":"' + udfTemplate + '","udfX":"' + udfX + '","udfY":"' + udfY + '","udfZ":"' + udfZ + '","udfSide":"' + udfSide + '"}}';
  console.log("jsonNum-------" + jsonNum);
  SendMessage(jsonNum);
...
async function ApiExtDriveUDF(udfRefCsysName, udfName, udfX, udfY, udfZ, udfSide) {
  ...
  var ret;
  var jsonNum = '{"ApiName": "ApiExtDriveUDF","Arguments":{ "filename": "","udfRefCsysName":"' + udfRefCsysName + '","udfName":"' + udfName + '","udfX":"' + udfX + '","udfY":"' + udfY + '","udfZ":"' + udfZ + '","udfSide":"' + udfSide + '"}}';
  console.log("jsonNum-------" + jsonNum);
  SendMessage(jsonNum);
...
async function apiDownloadFile(Url, DownloadDirectory, NewFileName) {
  ...
  SendMessage(
    ...
    '{"ApiName":"ApiDownloadFile","Arguments":{"Url":"' + Url + '","DownloadDirectory":"' + DownloadDirectory + '","NewFileName":"' + NewFileName + '"}}'
  );
  ret = await ReceiveMessage();
  console.log("ret-------" + ret);
  return ret;
...
async function apiUnPackFiles(zipFilePath, unPackDirectory) {
  ...
  var ret
  SendMessage(
    '{"ApiName":"ApiUnPackFiles","Arguments":{"ZipFilePath":"' + zipFilePath + '","UnPackDirectory":"' + unPackDirectory + '"}}'
  );
  ret = await ReceiveMessage();
  console.log("ret-------" + ret);
  return ret;
...
async function ApiOpenTopAsmTemplateInterface(modelNum, modelType, NewTopAsmName, PtcCommonName, parametersStr) {
  ...
  console.log('{"ApiName":"ApiOpenTopAsmTemplateInterface","Arguments":{"TopAsmModelPath":"' + filePath + '","NewTopAsmName":"' + NewTopAsmName + '","PtcCommonName":"' + PtcCommonName + '","Parameters":[' + parametersStr + ']}}', '打印结果');
  var ret
  SendMessage('{"ApiName":"ApiOpenTopAsmTemplateInterface","Arguments":{"TopAsmModelPath":"' + filePath + '","NewTopAsmName":"' + NewTopAsmName + '","PtcCommonName":"' + PtcCommonName + '","Parameters":[' + parametersStr + ']}}');
  ret = await ReceiveMessage();
  console.log("ret-------+" + ret);
  return ret;
}
