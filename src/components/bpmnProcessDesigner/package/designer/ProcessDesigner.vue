  ...
  <div class="my-process-designer">
      ...
      <template v-if="!$slots['control-header']">
        ...
        <ElButtonGroup key="align-control">
          <el-tooltip effect="light" content="向左对齐">
            <XButton preIcon="mdi:format-align-left" @click="elementsAlign('left')" />
          </el-tooltip>
          <el-tooltip effect="light" content="向右对齐">
            <XButton preIcon="mdi:format-align-right" @click="elementsAlign('right')" />
          </el-tooltip>
          <el-tooltip effect="light" content="向上对齐">
            <XButton preIcon="mdi:format-align-top" @click="elementsAlign('top')" />
          </el-tooltip>
          <el-tooltip effect="light" content="向下对齐">
            <XButton preIcon="mdi:format-align-bottom" @click="elementsAlign('bottom')" />
          </el-tooltip>
          <el-tooltip effect="light" content="水平居中">
            <XButton preIcon="mdi:format-align-center" @click="elementsAlign('center')" />
          </el-tooltip>
          <el-tooltip effect="light" content="垂直居中">
            <XButton preIcon="mdi:format-align-middle" @click="elementsAlign('middle')" />
          </el-tooltip>
        </ElButtonGroup>
        ...
        <ElButtonGroup key="panel-control">
          <el-tooltip effect="light" :content="showPalette ? '隐藏流程元素' : '显示流程元素'">
            <XButton
              :preIcon="showPalette ? 'ep:fold' : 'ep:unfold'"
              :title="showPalette ? '隐藏流程元素' : '显示流程元素'"
              @click="togglePalette()" />
          </el-tooltip>
          <el-tooltip effect="light" :content="showProperties ? '隐藏属性面板' : '显示属性面板'">
            <XButton
              :preIcon="showProperties ? 'ep:close-notification' : 'ep:notification'"
              :title="showProperties ? '隐藏属性面板' : '显示属性面板'"
    ...
    <div class="my-process-designer__container">
      <div
        ...
        ref="bpmnCanvas"
        id="bpmnCanvas"
        style="width: 1680px; height: 800px"></div>
...
const showPalette = ref(true) // 控制流程元素面板显示
...
const togglePalette = () => {
  ...
  if (paletteElement) {
    ;(paletteElement as HTMLElement).style.display = showPalette.value ? 'block' : 'none'
  }
}
