...
<template>
    ...
    <div class="node-container">
      <div
        ...
        <div class="node-content" @click="nodeClick">
          <div v-if="currentNode.showText" class="node-text" :title="currentNode.showText">
  ...
  <!-- 审批记录 -->
  <el-dialog v-model="dialogVisible" :title="dialogTitle || '审批记录'" width="1000px" append-to-body>
    <el-row>
