<template>
  <div class="branch-node-wrapper">
    <div class="branch-node-container">
      ...
      <el-button v-else class="branch-node-add" color="#67c23a" @click="addCondition" plain>添加条件</el-button>
      ...
      <div class="branch-node-item" v-for="(item, index) in currentNode.conditionNodes" :key="index">
        ...
        <div class="node-wrapper">
          <div class="node-container">
            <div
              class="node-box"
              :class="[{ 'node-config-error': !item.showText }, `${useTaskStatusClass(item.activityStatus)}`]">
...
// 递归从父节点中查询匹配的节点
const recursiveFindParentNode = (nodeList: SimpleFlowNode[], node: SimpleFlowNode, nodeType: number) => {
