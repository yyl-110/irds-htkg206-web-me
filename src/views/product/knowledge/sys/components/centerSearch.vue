<template>
  <div class="centerSearch" v-dragModal>
    <a-modal :getContainer="customGetContainer" :maskClosable="false" class="layout" :visible="addDataDialogVisible"
      title="添加数据" width="70%" @cancel="handleClose" height="80%" @ok="confirmDialog">
