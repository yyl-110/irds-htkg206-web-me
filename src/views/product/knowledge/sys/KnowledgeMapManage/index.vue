...
import addAndEditTree from '../components/add-and-deit-tree.vue'
...
async function getNodeAddData(selectedKeys: any) {
  ...
  // 这里可以根据需要实现添加节点的逻辑
  addAndEditTreeRef.value.show(selectedKeys, {}, 1);
}
  ...
  <div class="drawerContent">
    ...
    <Splitpanes class="default-theme sbom">
      ...
      <Pane class="splitpane-cls">
        <mapDataTable :kldTreeId="kldTreeIds" :tagList="tagList" />
      </Pane>
    </Splitpanes>
    <addAndEditTree ref="addAndEditTreeRef" :tagList="tagList" @saveSuccess="saveSuccess" />
  </div>
</template>
