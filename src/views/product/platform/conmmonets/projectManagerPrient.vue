        ...
        <a-row :gutter="[16, 16]">
          ...
          <a-col :span="12">
            <a-form-item label="产品业务分类" name="businessClassification">
              <a-select allowClear v-model:value="editFormData.businessClassification" placeholder="请选择产品业务分类">
          ...
          <a-col :span="12">
            <a-form-item label="研发进展" name="projectPercentage">
              <a-progress :percent="editFormData.projectPercentage" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="风险管控" name="riskControl">
              <a-input v-model:value="editFormData.riskControl" placeholder="请输入风险管控" allowClear />
            </a-form-item>
          </a-col>
          <a-col :span="12">
...
const partNameFile = ref('');
async function reloadTableParameter(selectedKeys: any) {
  loading.value = true;
  console.log(selectedKeys);
  seriesParameter.proId = selectedKeys.key;
  partNameFile.value = selectedKeys.partName;
  const res = await AdminApiSystemProduct.getProductListByParentProId(seriesParameter);
...
async function exportParameterInfo() {
  try {
    loading.value = true;
    const res = await AdminApiSystemProduct.exportProjectInfoByProId(seriesParameter);
    const fileName = partNameFile.value + '.xlsx';
