...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    function customGetContainer() {
      // 返回自定义挂载节点
      return document.querySelector('.savegbomparamterModal');
    }
...
<template>
  <div class="savegbomparamterModal" v-dragModal>
    <a-modal
      ...
      <div class="user-page" style="display: flex; justify-content: space-between">
        <div v-show="showLeft" class="wei-content-full left-tree">
          <a-directory-tree
            style="height: calc(100vh - 333px); width: 240px; overflow-y: auto"
            :show-icon="true"
