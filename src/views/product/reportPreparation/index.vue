...
<template>
  <div class="report-preparation-page">
    ...
    <a-form v-if="paramRows.length > 0" layout="vertical" class="dynamic-form">
      <div v-for="(row, rowIndex) in paramRows" :key="rowIndex" class="dynamic-row">
        <a-row :gutter="20">
          <a-col v-for="item in row" :key="item.para2" :span="6">
            <a-form-item :label="item.para1">
