...
import UdfAddOrUpdate from '../modal/UdfAddOrUpdate.vue';
...
<template>
  ...
  <UdfAddOrUpdate ref="addOrUpdate" :modal-visible="AddVisible" @modal-init="modalInit" @on-close="AddVisible = false" />
