  ...
  <a-modal
    ...
    <div v-if="!loading" class="modal-body">
      <section class="module-section">
        ...
        <a-form ref="formRef" layout="vertical" :model="modelData" :label-col="labelCol" class="form-grid udf-basic-grid">
          <a-form-item label="UDF编号：" name="para1" :rules="[{ required: true, message: '请输入UDF编号' }]">
            <a-input v-model:value="modelData.para1" placeholder="请输入UDF编号" allow-clear />
          </a-form-item>

          <a-form-item label="UDF名称：" name="para2" :rules="[{ required: true, message: '请输入UDF名称' }]">
            <a-input v-model:value="modelData.para2" placeholder="请输入UDF名称" allow-clear />
          </a-form-item>

          <a-form-item label="UDF描述：" name="para3" class="udf-desc-item">
            <a-textarea v-model:value="modelData.para3" placeholder="请输入UDF描述" :rows="3" allow-clear />
          </a-form-item>
        </a-form>
      </section>
      <!-- 可变参数与附件区域 -->
