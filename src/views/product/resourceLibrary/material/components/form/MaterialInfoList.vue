...
import MaterialAddOrUpdate from '../modal/MaterialAddOrUpdate.vue';
...
<template>
  ...
  <MaterialAddOrUpdate ref="addOrUpdate" :modal-visible="AddVisible" @modal-init="modalInit" @on-close="AddVisible = false" />
