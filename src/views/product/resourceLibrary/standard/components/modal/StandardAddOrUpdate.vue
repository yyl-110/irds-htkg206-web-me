  ...
  <a-modal
    ...
    <div v-if="!loading" class="modal-body">
      <section class="module-section">
        ...
        <a-form ref="formRef" layout="vertical" :model="modelData" :label-col="labelCol" class="form-grid standard-basic-grid">
          <a-form-item label="主编码：" name="para1" :rules="[{ required: true, message: '请输入主编码' }]">
