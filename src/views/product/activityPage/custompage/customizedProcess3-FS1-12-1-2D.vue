  ...
  <div class="adapter-page">
    ...
    <div class="adapter-page__body">
      <a-form label-align="left" :colon="false" :label-col="formLabelCol" class="adapter-page__form">
        <div class="adapter-page__form-grid adapter-page__form-grid--d">
...
import { ADAPTER_PAGE_CONFIG } from './FS1_12_1_2D/config';
...
defineOptions({ name: 'customizedProcess3-FS1-12-1-2D' });
