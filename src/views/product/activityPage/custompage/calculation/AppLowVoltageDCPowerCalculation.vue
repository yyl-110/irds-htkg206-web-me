<template>
  <div class="page">
    <div class="layout-wrapper">
      <div class="page-title">低压直流功率计算</div>
...
import {
  buildLowVoltageDCTables,
  collectBranchParams,
  createBranchCountFields,
} from './lowVoltageDC/calculation';
import {
  createLowVoltageDCColumns1,
  createLowVoltageDCColumns2,
} from './lowVoltageDC/tableColumns';
import type { BranchCountField, LowVoltageDCRow } from './lowVoltageDC/types';

defineOptions({ name: 'AppLowVoltageDCPowerCalculation' });
