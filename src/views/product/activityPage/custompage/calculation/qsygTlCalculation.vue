<template>
  <div>
    <a-modal v-model:open="isShow" :mask-closable="false" :width="width" title="起竖油缸推力计算" @cancel="handleCancel">
...
defineOptions({ name: 'qsygTlCalculation' });
...
function resetForm() {
  ...
  groupData.value = [...DEFAULT_CYLINDER_ROWS];
  selectedRows.value = [];
}
