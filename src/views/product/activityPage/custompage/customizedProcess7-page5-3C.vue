...
import {
  cloneParameterList,
  initCustomizedProcessPage7Data5_3C,
  VARIANT_CONFIG,
  type AssemblyTableRow,
  type Page5_3ParameterItem,
} from './Process7-page5-3C/parameterDefaults';
...
defineOptions({ name: 'customizedProcess7-page5-3C' });
...
function createInitialParameterList(): Page5_3ParameterItem[] {
  if (!props.parameterTempList?.length) {
    return initCustomizedProcessPage7Data5_3C(props.pageid);
  }
