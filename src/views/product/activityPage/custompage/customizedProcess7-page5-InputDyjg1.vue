...
import { INPUT_DYJG1_SECTION } from './Process7-page5-InputDyjg/config';
...
defineOptions({ name: 'customizedProcess7-page5-InputDyjg1' });
...
const {
  ...
  onDownloadFile,
  updateEl,
} = useInputDyjgPage(props, emit, INPUT_DYJG1_SECTION);
