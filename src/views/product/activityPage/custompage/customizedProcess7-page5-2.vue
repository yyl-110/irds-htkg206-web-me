<template>
  <div>
    <div class="layout-wrapper" style="padding: 0 10px; min-height: 680px; background-color: #ffffff">
        ...
        <a-form label-align="left" :colon="false">
          <div style="width: 100%; font-weight: 600; padding-left: 10px; height: 120px">
            ...
            <div style="width: 100%; float: left; height: 47px">
              <a-form-item label="柜体最大高尺寸:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px">
                <a-input v-model:value="parameterTempList[0].defaultValue" style="width: 100px" allow-clear disabled />
              </a-form-item>
              <a-form-item label="柜体最大深:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px; margin-left: 120px">
                <a-input v-model:value="parameterTempList[1].defaultValue" style="width: 100px" allow-clear disabled />
              </a-form-item>
            </div>
            <div style="width: 100%; float: left; height: 47px">
              <a-form-item label="柜体最大宽:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px">
                <a-input v-model:value="parameterTempList[2].defaultValue" style="width: 100px" allow-clear disabled />
              </a-form-item>
              <a-form-item label="额定输入电压(V):" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px; margin-left: 120px">
                <a-input v-model:value="parameterTempList[22].defaultValue" style="width: 100px" allow-clear disabled />
              </a-form-item>
            </div>
            <div style="width: 100%; float: left; height: 47px">
              <a-form-item label="输出路数:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px">
                <a-input v-model:value="parameterTempList[23].defaultValue" style="width: 100px" allow-clear disabled />
              </a-form-item>
              <a-form-item label="输入电压范围(V):" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px; margin-left: 120px">
          ...
          <div style="width: 100%; font-weight: 600; padding-left: 10px; height: 120px; margin-top: 15px">
            ...
            <div style="width: 100%; float: left; height: 47px">
              <a-form-item label="插箱高度(U)和:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px">
                <a-input v-model:value="parameterTempList[3].defaultValue" style="width: 100px" allow-clear disabled />
              </a-form-item>
              <a-form-item label="插箱最大宽:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px; margin-left: 120px">
                <a-input v-model:value="parameterTempList[6].defaultValue" style="width: 100px" allow-clear disabled />
              </a-form-item>
            </div>
            <div style="width: 100%; float: left; height: 47px">
              <a-form-item label="走线空间:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px">
                <a-input v-model:value="parameterTempList[4].defaultValue" style="width: 100px" allow-clear @blur="onWiringSpaceBlur" />
              </a-form-item>
              <a-form-item label="插箱最大深:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px; margin-left: 120px">
          ...
          <div style="width: 100%; font-weight: 600; float: left; height: 47px">
            <a-form-item label="柜体深(计算值):" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px; margin-left: 10px">
              <a-input v-model:value="parameterTempList[5].defaultValue" style="width: 100px" allow-clear disabled />
            </a-form-item>
            <a-form-item label="机柜出线方式:" :label-col="{ style: { width: '115px' } }" style="float: left; margin-bottom: 10px; margin-left: 120px">
              <a-select v-model:value="parameterTempList[20].defaultValue" style="width: 100px" @change="setSaveBtnEnable()">
                <a-select-option v-for="item in parameterTempList[20].selectStrVal ?? []" :key="item.label" :value="item.label">
                  {{ item.label }}
                </a-select-option>
              </a-select>
            </a-form-item>
...
import {
  cloneParameterList,
  initCustomizedProcessPage7Data5_2,
...
defineOptions({ name: 'customizedProcess7-page5-2' });
...
function createInitialParameterList(): Page5_2ParameterItem[] {
  if (!props.parameterTempList?.length) {
    return initCustomizedProcessPage7Data5_2(props.pageid);
  }
...
function moduleOk(payload: ModuleOkPayload) {
  applyModuleBrowseResult(parameterTempList.value, selectRow.value, payload);
