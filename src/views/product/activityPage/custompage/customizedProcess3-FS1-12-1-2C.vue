<template>
  <div class="adapter-page">
    ...
    <div class="adapter-page__body">
      <div class="adapter-page__init-bar">
...
import { ADAPTER_PAGE_CONFIG } from './FS1_12_1_2C/config';
...
defineOptions({ name: 'customizedProcess3-FS1-12-1-2C' });
