...
import { createDefaultFs151_1_1NParameterList, type Fs151_1_1NParameterItem } from './parameterDefaults';

export type { Fs151_1_1NParameterItem };

async function applyActivityParameterIds(pageId: string, list: Fs151_1_1NParameterItem[]): Promise<Fs151_1_1NParameterItem[]> {
...
export async function loadFs151_1_1NPageParameters(pageId: string): Promise<Fs151_1_1NParameterItem[]> {
  const pageKey = String(pageId ?? '').trim();
  let list = createDefaultFs151_1_1NParameterList(pageKey);
  list = await applyActivityParameterIds(pageKey, list);
  return list;
}

export function extractFs151_1_1NSaveParamValues(list: Fs151_1_1NParameterItem[]) {
