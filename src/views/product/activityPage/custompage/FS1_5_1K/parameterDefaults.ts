...
export interface Fs15_1KParameterItem {
  inputType?: string;
  ifSingleLine?: string;
  pageId?: string;
  parameterId?: string;
...
export const SELECT_TABLE_NUM = 'FS1-5-1K';
export const CHECK_TABLE_NUM = 'FS1-5-1K-1';
export const MODULE_CATEGORY_ID = '505';

const SELECT_COL_STR = ['p0', 'p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8'];
const CHECK_COL_STR = [
...
export function createDefaultFs15_1KParameterList(pageId = ''): Fs15_1KParameterItem[] {
  return [
    {
      inputType: 'table',
      ifSingleLine: 't',
...
export function getSelectTableRows(list: Fs15_1KParameterItem[]): ConnectionTableRow[] {
  return (list[SELECT_TABLE_INDEX]?.tableMap?.rowData ?? []) as ConnectionTableRow[];
}

export function getCheckTableRows(list: Fs15_1KParameterItem[]): ConnectionTableRow[] {
  return (list[CHECK_TABLE_INDEX]?.tableMap?.rowData ?? []) as ConnectionTableRow[];
}

export function setSelectTableRows(list: Fs15_1KParameterItem[], rows: ConnectionTableRow[]) {
...
export function setCheckTableRows(list: Fs15_1KParameterItem[], rows: ConnectionTableRow[]) {
