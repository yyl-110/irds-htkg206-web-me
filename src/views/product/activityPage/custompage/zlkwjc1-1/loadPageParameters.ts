...
import { createDefaultZlkwjcParameterList, type ZlkwjcParameterItem } from './parameterDefaults';
...
export async function loadZlkwjcPageParameters(pageId: string): Promise<ZlkwjcParameterItem[]> {
