...
import {
  createDefaultPage1_1_1_1ParameterList,
  type Page1_1_1_1ParameterItem,
} from './parameterDefaults';

export type { Page1_1_1_1ParameterItem };

export function mergeSavedParamsIntoList(
  list: Page1_1_1_1ParameterItem[],
  saved?: Array<{ paramCode?: string; paramKey?: string; paramValue?: string }> | null,
): Page1_1_1_1ParameterItem[] {
...
async function applyActivityParameterIds(
  pageId: string,
  list: Page1_1_1_1ParameterItem[],
): Promise<Page1_1_1_1ParameterItem[]> {
...
export async function loadPage1_1_1_1PageParameters(
  pageId: string,
  saved?: Array<{ paramCode?: string; paramKey?: string; paramValue?: string }> | null,
): Promise<Page1_1_1_1ParameterItem[]> {
  const pageKey = String(pageId ?? '').trim();
  let list = createDefaultPage1_1_1_1ParameterList(pageKey);
