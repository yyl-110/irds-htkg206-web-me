...
import type { Page6ParameterItem, ProcessListItem } from './models';
...
export function runProcessCalculation(
  ...
  zldyxlPrm: string | number,
      ...
      data.forEach((item, index) => {
        ...
        if (item.p0 == "浣庡帇鐩存祦") {
          if (item.p10 != undefined && item.p10 != "" && item.p10 == 1) {
            ...
            powerLow1 =
              powerLow1 + (Number(item.p4) / Number(item.p8)) * Number(time1);
            powerDCbus1 = powerDCbus1 + Number(item.p4) / Number(item.p8);
            DCpower1 = DCpower1 + Number(item.p4);
            ACInput1 =
              ACInput1 +
              (Number(item.p4) * Number(time1)) /
                (Number(item.p8) * Number(item.p9));
            ACInputPower1 =
              ACInputPower1 +
              Number(item.p4) / (Number(item.p8) * Number(item.p9));
          }
          ...
          if (item.p12 != undefined && item.p12 != "" && item.p12 == 1) {
            ...
            powerLow2 =
              powerLow2 + (Number(item.p4) / Number(item.p8)) * Number(time2);
          ...
          if (item.p14 != undefined && item.p14 != "" && item.p14 == 1) {
            ...
            powerLow3 =
              powerLow3 + (Number(item.p4) / Number(item.p8)) * Number(time3);
          ...
          if (item.p16 != undefined && item.p16 != "" && item.p16 == 1) {
            ...
            powerLow4 =
              powerLow4 + (Number(item.p4) / Number(item.p8)) * Number(time4);
          ...
          if (item.p18 != undefined && item.p18 != "" && item.p18 == 1) {
            ...
            powerLow5 =
              powerLow5 + (Number(item.p4) / Number(item.p8)) * Number(time5);
          ...
          if (item.p20 != undefined && item.p20 != "" && item.p20 == 1) {
            ...
            powerLow6 =
              powerLow6 + (Number(item.p4) / Number(item.p8)) * Number(time6);
          ...
          if (item.p22 != undefined && item.p22 != "" && item.p22 == 1) {
            ...
            powerLow7 =
              powerLow7 + (Number(item.p4) / Number(item.p8)) * Number(time7);
          ...
          if (item.p24 != undefined && item.p24 != "" && item.p24 == 1) {
            ...
            powerLow8 =
              powerLow8 + (Number(item.p4) / Number(item.p8)) * Number(time8);
          ...
          if (item.p26 != undefined && item.p26 != "" && item.p26 == 1) {
            ...
            powerLow9 =
              powerLow9 + (Number(item.p4) / Number(item.p8)) * Number(time9);
          ...
          if (item.p28 != undefined && item.p28 != "" && item.p28 == 1) {
            ...
            powerLow10 =
              powerLow10 + (Number(item.p4) / Number(item.p8)) * Number(time10);
          ...
          if (item.p30 != undefined && item.p30 != "" && item.p30 == 1) {
            ...
            powerLow11 =
              powerLow11 + (Number(item.p4) / Number(item.p8)) * Number(time11);
          ...
          if (item.p32 != undefined && item.p32 != "" && item.p32 == 1) {
            ...
            powerLow12 =
              powerLow13 + (Number(item.p4) / Number(item.p8)) * Number(time12);
          ...
          if (item.p34 != undefined && item.p34 != "" && item.p34 == 1) {
            ...
            powerLow13 =
              powerLow13 + (Number(item.p4) / Number(item.p8)) * Number(time13);
          ...
          if (item.p36 != undefined && item.p36 != "" && item.p36 == 1) {
            ...
            powerLow14 =
              powerLow14 + (Number(item.p4) / Number(item.p8)) * Number(time14);
          ...
          if (item.p38 != undefined && item.p38 != "" && item.p38 == 1) {
            ...
            powerLow15 =
              powerLow15 + (Number(item.p4) / Number(item.p8)) * Number(time15);
          ...
          if (item.p40 != undefined && item.p40 != "" && item.p40 == 1) {
            ...
            powerLow16 =
              powerLow16 + (Number(item.p4) / Number(item.p8)) * Number(time16);
          ...
          if (item.p42 != undefined && item.p42 != "" && item.p42 == 1) {
            ...
            powerLow17 =
              powerLow17 + (Number(item.p4) / Number(item.p8)) * Number(time17);
          ...
          if (item.p44 != undefined && item.p44 != "" && item.p44 == 1) {
            ...
            powerLow18 =
              powerLow18 + (Number(item.p4) / Number(item.p8)) * Number(time18);
          ...
          if (item.p46 != undefined && item.p46 != "" && item.p46 == 1) {
            ...
            powerLow19 =
              powerLow19 + (Number(item.p4) / Number(item.p8)) * Number(time19);
          ...
          if (item.p48 != undefined && item.p48 != "" && item.p48 == 1) {
            ...
            powerLow20 =
              powerLow20 + (Number(item.p4) / Number(item.p8)) * Number(time20);
        ...
        if (item.p10 != undefined && item.p10 != "" && item.p10 == 1) {
          ...
          totalElectricity1 =
            totalElectricity1 + Number(item.p4) * Number(time1);
        }
        ...
        if (item.p12 != undefined && item.p12 != "" && item.p12 == 1) {
          ...
          totalElectricity2 =
            totalElectricity2 + Number(item.p4) * Number(time2);
        }
        ...
        if (item.p14 != undefined && item.p14 != "" && item.p14 == 1) {
          ...
          totalElectricity3 =
            totalElectricity3 + Number(item.p4) * Number(time3);
        }
        ...
        if (item.p16 != undefined && item.p16 != "" && item.p16 == 1) {
          ...
          totalElectricity4 =
            totalElectricity4 + Number(item.p4) * Number(time4);
        }
        ...
        if (item.p18 != undefined && item.p18 != "" && item.p18 == 1) {
          ...
          totalElectricity5 =
            totalElectricity5 + Number(item.p4) * Number(time5);
        }
        ...
        if (item.p20 != undefined && item.p20 != "" && item.p20 == 1) {
          ...
          totalElectricity6 =
            totalElectricity6 + Number(item.p4) * Number(time6);
        }
        ...
        if (item.p22 != undefined && item.p22 != "" && item.p22 == 1) {
          ...
          totalElectricity7 =
            totalElectricity7 + Number(item.p4) * Number(time7);
        }
        ...
        if (item.p24 != undefined && item.p24 != "" && item.p24 == 1) {
          ...
          totalElectricity8 =
            totalElectricity8 + Number(item.p4) * Number(time8);
        }
        ...
        if (item.p26 != undefined && item.p26 != "" && item.p26 == 1) {
          ...
          totalElectricity9 =
            totalElectricity9 + Number(item.p4) * Number(time9);
        }
        ...
        if (item.p28 != undefined && item.p28 != "" && item.p28 == 1) {
          ...
          totalElectricity10 =
            totalElectricity10 + Number(item.p4) * Number(time10);
        }
        ...
        if (item.p30 != undefined && item.p30 != "" && item.p30 == 1) {
          ...
          totalElectricity11 =
            totalElectricity11 + Number(item.p4) * Number(time11);
        }
        ...
        if (item.p32 != undefined && item.p32 != "" && item.p32 == 1) {
          ...
          totalElectricity12 =
            totalElectricity12 + Number(item.p4) * Number(time12);
        }
        ...
        if (item.p34 != undefined && item.p34 != "" && item.p34 == 1) {
          ...
          totalElectricity13 =
            totalElectricity13 + Number(item.p4) * Number(time13);
        }
        ...
        if (item.p36 != undefined && item.p36 != "" && item.p36 == 1) {
          ...
          totalElectricity14 =
            totalElectricity14 + Number(item.p4) * Number(time14);
        }
        ...
        if (item.p38 != undefined && item.p38 != "" && item.p38 == 1) {
          ...
          totalElectricity15 =
            totalElectricity15 + Number(item.p4) * Number(time15);
        }
        ...
        if (item.p40 != undefined && item.p40 != "" && item.p40 == 1) {
          ...
          totalElectricity16 =
            totalElectricity16 + Number(item.p4) * Number(time16);
        }
        ...
        if (item.p42 != undefined && item.p42 != "" && item.p42 == 1) {
          ...
          totalElectricity17 =
            totalElectricity17 + Number(item.p4) * Number(time17);
        }
        ...
        if (item.p44 != undefined && item.p44 != "" && item.p44 == 1) {
          ...
          totalElectricity18 =
            totalElectricity18 + Number(item.p4) * Number(time18);
        }
        ...
        if (item.p46 != undefined && item.p46 != "" && item.p46 == 1) {
          ...
          totalElectricity19 =
            totalElectricity19 + Number(item.p4) * Number(time19);
        }
        ...
        if (item.p48 != undefined && item.p48 != "" && item.p48 == 1) {
          ...
          totalElectricity20 =
            totalElectricity20 + Number(item.p4) * Number(time20);
        }
      });
      ...
      ACInput1 = process1 + ACInput1;
      ACInput2 = process2 + ACInput2;
      ACInput3 = process3 + ACInput3;
      ACInput4 = process4 + ACInput4;
      ACInput5 = process5 + ACInput5;
      ACInput6 = process6 + ACInput6;
      ACInput7 = process7 + ACInput7;
      ACInput8 = process8 + ACInput8;
      ACInput9 = process9 + ACInput9;
      ACInput10 = process10 + ACInput10;
      ACInput11 = process11 + ACInput11;
      ACInput12 = process12 + ACInput12;
      ACInput13 = process13 + ACInput13;
      ACInput14 = process14 + ACInput14;
      ACInput15 = process15 + ACInput15;
      ACInput16 = process16 + ACInput16;
      ACInput17 = process17 + ACInput17;
      ACInput18 = process18 + ACInput18;
      ACInput19 = process19 + ACInput19;
      ACInput20 = process20 + ACInput20;

      ACInputPower1 = ACpower1 + ACInputPower1;
      ACInputPower2 = ACpower2 + ACInputPower2;
      ACInputPower3 = ACpower3 + ACInputPower3;
      ACInputPower4 = ACpower4 + ACInputPower4;
      ACInputPower5 = ACpower5 + ACInputPower5;
      ACInputPower6 = ACpower6 + ACInputPower6;
      ACInputPower7 = ACpower7 + ACInputPower7;
      ACInputPower8 = ACpower8 + ACInputPower8;
      ACInputPower9 = ACpower9 + ACInputPower9;
      ACInputPower10 = ACpower10 + ACInputPower10;
      ACInputPower11 = ACpower11 + ACInputPower11;
      ACInputPower12 = ACpower12 + ACInputPower12;
      ACInputPower13 = ACpower13 + ACInputPower13;
      ACInputPower14 = ACpower14 + ACInputPower14;
      ACInputPower15 = ACpower15 + ACInputPower15;
      ACInputPower16 = ACpower16 + ACInputPower16;
      ACInputPower17 = ACpower17 + ACInputPower17;
      ACInputPower18 = ACpower18 + ACInputPower18;
      ACInputPower19 = ACpower19 + ACInputPower19;
      ACInputPower20 = ACpower20 + ACInputPower20;
      ...
      let sumElectricity =
        ...
        totalElectricity19 +
        totalElectricity20;
      parameterTempList[1].defaultValue = handleCutZero(
        sumElectricity.toFixed(3)
      ); //鎬荤敤鐢甸噺
      ...
      let sumProcess =
        ...
        process19 +
        process20;
      parameterTempList[2].defaultValue = handleCutZero(
        sumProcess.toFixed(3)
      ); //鎬讳氦娴佺敤鐢甸噺
      ...
      let sumDirectCurrent =
        ...
        directCurrent19 +
        directCurrent20;
      parameterTempList[3].defaultValue = handleCutZero(
        sumDirectCurrent.toFixed(3)
      ); //鎬讳綆鍘嬬洿娴佺敤鐢甸噺
      ...
      let sumACInput =
        ...
        ACInput19 +
        ACInput20;
      parameterTempList[4].defaultValue = handleCutZero(
        sumACInput.toFixed(3)
      ); //鎬讳氦娴佽緭鍏ョ敤鐢甸噺
      ...
      parameterTempList[5].defaultValue = handleCutZero(
        sumACInputPower.toFixed(3)
      ); //鎬讳綆鍘嬬洿娴佹瘝绾跨敤鐢甸噺
}
