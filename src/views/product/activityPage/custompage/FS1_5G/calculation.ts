...
import { getCheckTableRows, setCheckTableRows, type ConnectionTableRow, type Fs15GParameterItem } from './parameterDefaults';

export const CHECK_EXCEL_NAME = 'FS1-5G.xls';
...
export async function runConnectionCheckCalculation(list: Fs15GParameterItem[], selectedRow: ConnectionTableRow) {
