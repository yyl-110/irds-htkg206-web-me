...
import { createDefaultFs151_1_1LParameterList, type Fs151_1_1LParameterItem } from './parameterDefaults';

export type { Fs151_1_1LParameterItem };

async function applyActivityParameterIds(pageId: string, list: Fs151_1_1LParameterItem[]): Promise<Fs151_1_1LParameterItem[]> {
...
export async function loadFs151_1_1LPageParameters(pageId: string): Promise<Fs151_1_1LParameterItem[]> {
  const pageKey = String(pageId ?? '').trim();
  let list = createDefaultFs151_1_1LParameterList(pageKey);
  list = await applyActivityParameterIds(pageKey, list);
  return list;
}

export function extractFs151_1_1LSaveParamValues(list: Fs151_1_1LParameterItem[]) {
