...
import { getDesignTableRows, setDesignTableRows, type Fs151_1_4ParameterItem } from './parameterDefaults';
...
export function runInnerSkinDesignCalculation(list: Fs151_1_4ParameterItem[]) {
