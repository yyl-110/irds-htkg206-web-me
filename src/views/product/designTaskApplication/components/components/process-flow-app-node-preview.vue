...
watch(
  () => [props.componentsJson, props.savedParamValues, props.savedTables, props.projectParamMap, props.otherTasksParamMap, props.taskSavedParamMap, props.wbsCollabMode],
  () => {
    const list = previewList.value;
