...
const emit = defineEmits([
  "onChangeElCheckTagOne",
  "onChangeElCheckTagTwo",
  "onOffFun",
]);
...
// watch(
//   () => props.elTagcheckedOneData,
//   (val) => {
//     nextTick(() => {
//       props.elTagcheckedOneData = val;
//     });
//   },
//   {
//     deep: true,
...
<template>
  <div class="classify">
        ...
        <div class="second">
          ...
          <div class="el-check-tag-wrap1">
            <a-checkbox
              ...
              :key="item.id"
              :checked="item.check"
              @change="(val) => tagChangeOne(item, index)"
              >{{ item.nodeName }}</a-checkbox
            >
          </div>
        </div>
        <span
          v-if="elTagcheckedOneData.length > 11"
          class="btn"
          @click="clickOffFun('elTagcheckedOne')"
        >
    ...
    <div
      v-if="
        hiddenStatus &&
        elTagcheckedTwoData.length > 0 &&
        elTagcheckedOneData.length > 0
      "
      class="cla-list"
    >
      <div class="total">
        ...
        <span
          v-if="elTagcheckedTwoData.length > 11"
          class="btn"
          @click="clickOffFun('elTagcheckedTwo')"
        >
