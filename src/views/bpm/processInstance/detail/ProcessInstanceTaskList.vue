<template>
  <el-table :data="tasks" border header-cell-class-name="table-header-gray">
    <el-table-column :label="$t('审批节点')" prop="name" min-width="120" align="center" />
    <el-table-column :label="$t('审批人')" min-width="100" align="center">
    ...
    <el-table-column align="center" :label="$t('审批建议')" prop="reason" min-width="200">
      <template #default="scope">
        {{ scope.row.reason }}
        <!-- <el-button
          class="ml-10px"
    ...
    <el-table-column align="center" :label="$t('耗时')" prop="durationInMillis" min-width="100">
      <template #default="scope">
