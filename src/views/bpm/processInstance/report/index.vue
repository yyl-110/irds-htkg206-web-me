<template>
  <ContentWrap>
    ...
    <el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
      <el-form-item :label="$t('发起人')" prop="startUserId">
        <el-select v-model="queryParams.startUserId" :placeholder="$t('请选择发起人')" class="!w-240px">
      ...
      <el-form-item :label="$t('流程状态')" prop="status">
        <el-select v-model="queryParams.status" :placeholder="$t('请选择流程状态')" clearable class="!w-240px">
          <el-option
      ...
      <el-form-item :label="$t('发起时间')" prop="createTime">
        <el-date-picker
  ...
  <ContentWrap>
    <el-table v-loading="loading" border :data="list">
      <el-table-column :label="$t('流程名称')" align="center" prop="name" fixed="left" width="200" />
      <el-table-column :label="$t('流程发起人')" align="center" prop="startUser.nickname" width="120" />
      <el-table-column :label="$t('流程状态')" prop="status" width="120">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.BPM_PROCESS_INSTANCE_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column :label="$t('发起时间')" align="center" prop="startTime" width="180" :formatter="dateFormatter" />
