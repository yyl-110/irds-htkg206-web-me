...
import type { MenuCreateRequestDTO } from '../../tags/data-contracts';

/** 管理后台 - 菜单创建 Request DTO */
export class CommonCreateRequestDTOModulemanaGementModel extends BaseModel implements MenuCreateRequestDTO {
  /**
   * 菜单名称
   * @minLength 0
   * @maxLength 50
