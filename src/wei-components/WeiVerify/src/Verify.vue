<script name="Verify" lang="ts" type="text/babel">
import { computed, defineComponent, defineEmits, ref, toRefs, watchEffect } from 'vue';
...
const emit = defineEmits(['cancelLoginloading']);
  ...
  <div v-show="showBox" :class="mode === 'pop' ? 'mask' : ''">
    <div :class="mode === 'pop' ? 'verifybox' : ''" :style="{ 'max-width': `${parseInt(imgSize.width) + 20}px` }">
      <div v-if="mode === 'pop'" class="verifybox-top">
        ...
        <div class="verifybox-close" @click="closeBox">
          <!-- <i class="iconfont icon-close" style="width: 14px; height: 14px;"></i> -->
          <CloseOutlined />
        </div>
      </div>
