declare module 'web-storage-cache' {
  ...
  class WebStorageCache<T = any> {
    ...
    /**
     * {@link WebStorageCache} 内部使用的 `storage`
     * @see 参考 [🔗 this.storage](https://github.com/wuchangming/web-storage-cache/blob/master/src/web-storage-cache.js#L352C14-L352C21)
     */
    storage!: Storage
